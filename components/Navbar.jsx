    ...
    return (
        <div>
            <div className={styles.navbar}>
                <Image
                    src={require("/public/img/utils/logo.png")}
                    alt="logo"
                    quality={100}
                    width={213}
                    height={102.7}
            ...
            <div className={styles.navbarMobile}>
                ...
                <div className={styles.menubtn} onClick={handleMenu()}>
                    <div className={`${styles.line} ${styles.top}`} ref={iconTop}/>
                    <div className={`${styles.line} ${styles.mid}`} ref={iconMid}/>
                    <div className={`${styles.line} ${styles.bot}`} ref={iconBtm}/>
                </div>
            </div>
            <div
