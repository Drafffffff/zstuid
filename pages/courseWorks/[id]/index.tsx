...
import {BilibiliVideo, LOCAL_URL, MainTexts, Title1, Title2} from "../../../components/utils";
...
const WorkDetail: NextPage = ({
    ...
    useEffect(() => {
        fetch(`http://${LOCAL_URL}:1337/course-works/${id}`)
            .then(res => res.json())
            .then(data => {
    ...
    async function handleLike() {
        ...
        await fetch(`http://${LOCAL_URL}:1337/course-works/${id}`, {
            method: "PUT",
